...
int count_eggs_in_the_warehouse(unsigned int);
...
unsigned char generate_output(unsigned int eggs_in_the_box, unsigned int eggs_in_the_warehouse){
    ...
    */
    unsigned char output_byte = eggs_in_the_box;
...
int count_eggs_in_the_warehouse(unsigned int byte_received){
